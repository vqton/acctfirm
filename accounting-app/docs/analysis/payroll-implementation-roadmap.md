...
> **Hiện trạng code:** PayrollService 669 lines, 44 tests, **1 controller (PayrollController, 203 lines), 9 views, 35 routes**
...
### 1.2 What Must Be Built (Remaining)

| Layer | Đã có | Cần xây thêm | Ghi chú |
|---|---|---|---|
| DB migrations | 12+ payroll-related | ~2-3 | employees mở rộng + tables mới |
| Models mới | PayrollEntry, PayrollDetail, PayrollPeriod, Employee | ~5 | Allowance, Attendance, Payslip, Overtime, Leave, Advance, Adjustment, Config |
| Repository Interfaces | PayrollEntry, PayrollPeriod, SalaryComponent, Employee | ~4 | |
| PDO Repositories | PayrollEntry, PayrollPeriod, SalaryComponent, Employee | ~4 | |
| Controllers | PayrollController (203 lines, 10+ methods) | ~7 | Employee, Attendance, Payslip, Payment, Tax, FinalSettlement, Config |
| Views / UI Screens | 9 (payroll, employees, periods, entries, calculate, insurance, tax, payslip, BHXH) | ~11 | |
| Services mới (hoặc mở rộng) | PayrollService (669 lines) | ~5 | Attendance, Payment, Tax, FinalSettlement, Config |
| Tests mới | 44 existing | ~140 (tổng) | Ngoài 44 existing |
