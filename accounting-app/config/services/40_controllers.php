...
use Accounting\Interfaces\HTTP\Financial\PrintTemplateController;
...
$printTemplateController = new PrintTemplateController($printTemplateService, $pdo);
...
$inventoryTransitController = new InventoryTransitController($inventoryService);
...
$promotionalController = new PromotionalController($inventoryService);
$returnToSupplierController = new ReturnToSupplierController($inventoryService, $itemRepository, $pdo);
$writeOffController = new WriteOffController($inventoryService);
