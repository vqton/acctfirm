...
class VoucherService
{
     ...
     *
     * @param string $prefix Mã loại chứng từ (VD: 'PC' = Phiếu chi, 'PT' = Phiếu thu, 'JV' = Journal Voucher)
     * @return string Số chứng từ đã format theo mẫu {PREFIX}{YYYY}-{000000}
     * @throws \PDOException Lỗi cơ sở dữ liệu hoặc lock wait timeout
     * @throws \Exception Lỗi không xác định — transaction được rollback tự động
     */
