...
class ValuationMethodController
{
    ...
    public function __construct(ValuationMethodRepositoryInterface $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function create(): void
    {
        ...
        $item = new ValuationMethod(
            $data['id'] ?? uniqid('vm_'), $data['code'], $data['name'], $data['description'] ?? null
        );
        $this->repo->save($item);
