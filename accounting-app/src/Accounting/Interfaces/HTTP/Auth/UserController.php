...
class UserController
{
    ...
    /**
     * Danh sách người dùng — yêu cầu quyền system.view
     *
     * @return void
     */
    ...
    /**
     * Tạo người dùng mới — hash password + gán vai trò
     *
     * NGHIỆP VỤ: INSERT users + INSERT user_roles
     ...
     *
     * NGHIỆP VỤ: Chỉ update các field được gửi lên. Password được hash lại.
     * Khi role_ids thay đổi: DELETE + INSERT user_roles.
    ...
    /**
     * Vô hiệu hóa người dùng (soft delete) — không xóa khỏi DB
     *
     * NGHIỆP VỤ: FORBIDDEN — không DELETE vật lý (soft delete = status='inactive')
