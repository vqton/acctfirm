...
<div class="toolbar">
    ...
    <div>
        <button class="btn btn-outline-success btn-sm me-1" onclick="exportCSV('#dataBody', 'danh-sach-vat-tu')"><i class="bi bi-file-earmark-excel"></i> Xuất Excel</button>
        <button class="btn btn-outline-primary btn-sm me-1" onclick="importFromExcel('items')"><i class="bi bi-upload"></i> Nhập Excel</button>
