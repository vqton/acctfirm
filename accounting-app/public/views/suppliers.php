...
function openCreate(){editId=null;document.getElementById('dataForm').reset();document.getElementById('modalTitle').textContent='Thêm mới nhà cung cấp';$('#dataModal').modal('show');}
function openEdit(id){
    editId=id;fetch(API+'/'+id).then(function(r){return r.json();}).then(function(i){
        ...
        document.getElementById('modalTitle').textContent='Sửa nhà cung cấp';$('#dataModal').modal('show');
