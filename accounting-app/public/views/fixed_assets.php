...
<div class="toolbar">
    ...
    <div><button class="btn btn-outline-success btn-sm me-1" onclick="exportCSV('#dataBody', 'danh-sach-tai-san-co-dinh')"><i class="bi bi-file-earmark-excel"></i> Xuất Excel</button><button class="btn btn-outline-primary btn-sm me-1" onclick="importFromExcel('fixed_assets')"><i class="bi bi-upload"></i> Nhập Excel</button><button class="btn btn-primary btn-sm" onclick="openCreate()"><i class="bi bi-plus-lg"></i> Thêm mới</button></div>
</div>
